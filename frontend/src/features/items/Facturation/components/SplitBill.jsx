...
export default function SplitBill(props) {
    ...
    return (
        <>
            <div className="bg-gray-800 text-white rounded-lg max-h-[500px] overflow-y-auto p-4">
            ...
            <div className="bg-gray-800 text-white rounded-lg max-h-[500px] overflow-y-auto p-4 ml-2">
